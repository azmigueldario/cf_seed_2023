...
import_biom("processed_data/bracken_cf.biom")
  # taxpasta simplified
import_biom("processed_data/bracken_ncfb_simplified.biom")
  # created with kraken-biom
import_biom("processed_data/bracken_cf_kraken_biom.biom")
  # using otu_table()
...
otu_table(cf_matrix[,c(-1:-3)], taxa_are_rows = TRUE)
